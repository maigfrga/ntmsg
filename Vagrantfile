...
Vagrant.configure(2) do |config|
  ...
  config.vm.network "private_network", ip: "192.168.47.10", netmask: '255.255.255.0'
  ...
  # documentation for more information about their specific syntax and use.
   config.vm.provision "shell", inline: <<-SHELL
        ...
        sudo apt-get install python3-pip  python3-flake8 python3-dev  libjpeg-dev git  -y
        ...
        sudo -u postgres psql -c "CREATE DATABASE test_ds;"
        sudo -u postgres psql -c "CREATE DATABASE ds_test;"
        sudo -u postgres psql -c "ALTER DATABASE test_ds OWNER TO ds;"
        sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE ds to ds;"
        sudo -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE test_ds to ds;"
        ...
        sudo pip3 install -r /src/tools/requirements.txt
   SHELL
end
